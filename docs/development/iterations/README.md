...
| 迭代 | 状态 | 范围 |
| --- | --- | --- |
| [ITER-0001](0001-electron-foundation.md) | `in-progress` | 治理、版本契约、Electron 信任边界、源码模式 UDS 纵切 |
| [ITER-0002](0002-bundled-runtimes.md) | `planned` | Python `onedir`、Node/QMD worker、MCP 与 CLI preflight |
