...
| [ITER-0002/R13](0002-r13-pre1-incremental-retirement.md) | `in-progress`（W01 remediation technical checkpoint `pass` / activation pending） | ADR-0016、W01–W16、增量 removal 与工程测试包治理 |
...
| [ITER-0008](0008-incremental-retirement-engineering-package.md) | `planned` | 最小 packaged smoke、增量 legacy slices、cleaned-tree 工程包与 final cutover |
