...
| TODO-GOV-EVIDENCE-001 | W01/P0 | `planned` | REQ-GOV-001、REQ-PRE1-SEQUENCING-001；现有 evidence 治理规则 | `docs/development/{evidence/**,iterations/**,status.md,traceability.md}`、PR/commit-bound evidence ledger | VAL-GOV-001 final head；每个 `pass` 绑定 commit/environment/command/result |
| TODO-CI-COVERAGE-001 | W01/P0 | `planned` | REQ-GOV-001、REQ-CI-001、REQ-PRE1-SEQUENCING-001；ADR-0009/0014 的 source/release CI 边界 | `Makefile`、`.github/workflows/**`、`desktop/workers/qmd/**`、`guide-site/**`、coverage manifest/docs | VAL-CI-COVERAGE-001 `not-run` |
...
| VAL-PRE1-SEQUENCE-001 | repository checkout；`make pre1-work-plan-check` + links/version/diff；exact W01–W16 rank、完整 work/task/gate/status 映射、formal not-run、W02 < W10/W11 < W03 < W13 < W14 < W15 < W16；11 个负向 fixtures | `not-run`（final head）；local authoring observation `pass` |
