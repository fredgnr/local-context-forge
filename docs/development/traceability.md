...
| VAL-LEGACY-SCOPE-001 | documentation review；每个候选 path/capability 为 remove/retain/split，稳定 REQ/TODO/VAL 和 external-data non-goal 完整 | `not-run`；R12 final commit-bound review 待执行 |
